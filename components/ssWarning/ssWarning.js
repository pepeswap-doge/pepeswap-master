    ...
    <Dialog fullScreen open={true} onClose={close} className={classes.dialogWrapper}>
      <div className={classes.dialogContainer}>
        <div className={classes.warningContainer}>
          ...
          <Typography className={classes.title1}>PepeSwap Disclaimer:</Typography>
          ...
          <Typography className={classes.paragraph} align="center">
            <span>
            Use of the PepeSwap.exchange website, services, dapp, or application is subject to the following terms and conditions and I hereby confirm that by proceeding and interacting with the protocol I am aware of these and accept them in full:
            </span>
            <br /><br />
            PepeSwap.exchange is a smart contract protocol in alpha stage of launch, and even though multiple security audits have been completed on the smart contracts, I understand the risks associated with using the PepeSwap protocol and associated functions.
            <br /><br />
            Any interactions that I have with the associated PepeSwap protocol apps, smart contracts or any related functions MAY place my funds at risk, and I hereby release the PepeSwap protocol and its contributors, team members, and service providers from any and all liability associated with my use of the above-mentioned functions.
            <br /><br />
